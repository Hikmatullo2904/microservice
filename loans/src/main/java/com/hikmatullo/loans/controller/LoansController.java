package com.hikmatullo.loans.controller;
...
import com.hikmatullo.loans.service.ILoansService;
...
public class LoansController {
    ...
    public ResponseEntity<ResponseDto> createLoan(@RequestParam
        ...
        return ResponseEntity
                ...
                .body(new ResponseDto( LoansConstants.MESSAGE_201, HttpStatus.OK));
    }
    ...
    public ResponseEntity<ResponseDto> updateLoanDetails(@Valid @RequestBody LoansDto loansDto) {
        ...
        if(isUpdated) {
            return ResponseEntity
                    ...
                    .body(new ResponseDto(LoansConstants.MESSAGE_200, HttpStatus.OK));
        }else{
            return ResponseEntity
                    .status(HttpStatus.EXPECTATION_FAILED)
                    .body(new ResponseDto(LoansConstants.MESSAGE_417_UPDATE, HttpStatus.EXPECTATION_FAILED));
        }
    }
